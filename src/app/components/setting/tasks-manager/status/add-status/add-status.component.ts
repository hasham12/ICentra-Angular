...
export class AddStatusComponent implements OnInit {
    ...
    AuthUser: any;
    constructor(private fb: FormBuilder, private Auth: AuthService, private formHelper: FormHelper, private toastr: ToastrService
                , private _location: Location, private api: ApiService, private router: Router) {
    }
    ...
    onSubmit() {
        ...
        this.api.post('/task-statuses', this.StatusForm.value).subscribe(res => {
                this.toastr.success('Status has been Created');
